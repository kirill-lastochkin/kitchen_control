...
<b>Важно:</b> если ты введешь, например, <i>'кабачок'</i>, а в списке ингридиентов будет написано <i>'5 кабачков'</i>, то такой рецепт\
не отфильтруется, поэтому лучше использовать в этой команде корень слова, в моем примере <i>'кабач'</i>.\n\
