...
/add_forbidden - <b>Исключить ингридиент из недельного меню.</b> После ввода команды отправь список ингридиентов через пробел.\n\
/del_forbidden - <b>Вернуть ингридиент в недельное меню.</b> После ввода команды отправь список ингридиентов через пробел.\
Можешь написать <i>все</i>, чтобы очистить список.\n\
/list_forbidden - <b>Показать список исключенных ингридиентов</b>"
